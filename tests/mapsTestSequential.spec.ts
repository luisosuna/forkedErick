...
test.describe.serial('Sequential Maps API Tests', () => {
  ...
  test.skip('Serial Get Known Place Info', async () => {
  ...
  test.skip('Serial Get Fake Place Info', async () => {
  ...
  test.skip('Serial Post New Place with Info', async () => {
  ...
  test.skip('Serial Put Update Existing Place with new address', async () => {
  ...
  test.skip('Serial Put Update Existing Place with new address, then Get and validate changes', async () => {
  ...
  test.skip('Serial Post, then Get, then Put with new address, then Get and validate changes', async () => {
